/**
 * EasyQRCodeJS / QRCode.js standalone minified bundle
 * Supports rendering to Canvas, SVG, Image, with logo & color options
 */
(function(window) {
  var QRCode;
  ...
  var QRUtil = {
    PATTERN_POSITION_TABLE: [
      ...
      [6, 26, 50, 74, 98, 122], [6, 30, 54, 78, 102, 126], [6, 26, 52, 78, 104, 130], [6, 30, 56, 82, 108, 134], [6, 34, 60, 86, 112, 138], [6, 30, 58, 86, 114, 142], [6, 34, 62, 90, 118, 146], [6, 30, 54, 78, 102, 126, 150], [6, 24, 50, 76, 102, 128, 154], [6, 28, 54, 80, 106, 132, 158], [6, 32, 58, 84, 110, 136, 162], [6, 26, 54, 82, 110, 138, 166], [6, 30, 58, 86, 114, 142, 170]
    ],
  ...
  // Main QRCode Object Constructor
    ...
    for (var row = 0; row < nCount; row++) {
      for (var col = 0; col < nCount; col++) {
        if (this._oQRCode.isDark(row, col)) {
          var nLeft = Math.round(col * nWidth);
          var nTop = Math.round(row * nHeight);
          var nRight = Math.round((col + 1) * nWidth) - nLeft;
          var nBottom = Math.round((row + 1) * nHeight) - nTop;
          ctx.fillRect(nLeft, nTop, nRight, nBottom);
        }
      }
    }
